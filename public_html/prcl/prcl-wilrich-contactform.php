...
<div class='container'>
    ...
    <textarea rows="10" cols="50" name='message' id='message'><?php echo $formproc->SafeDisplay('message') ?>I am interested in arranging a presentation by Petrel Robertson Consulting Ltd. on the "Analysis and Reservoir Characterization of the Wilrich Member and Falher Equivalents" Regional Study. </textarea>
</div>
