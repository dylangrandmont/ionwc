...
<div class='container'>
    ...
    <textarea rows="10" cols="50" name='message' id='message'><?php echo $formproc->SafeDisplay('message') ?>I am interested in arranging a presentation by Petrel Robertson Consulting Ltd. on the "Exploration and Development Potential of Viking and 'Notikewin' Reservoirs, West-Central Alberta" Regional Study.</textarea>
</div>
